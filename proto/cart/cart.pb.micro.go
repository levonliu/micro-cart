...
type CartService interface {
	...
	DeleteItemByID(ctx context.Context, in *CarID, opts ...client.CallOption) (*Response, error)
...
func (c *cartService) DeleteItemByID(ctx context.Context, in *CarID, opts ...client.CallOption) (*Response, error) {
...
func RegisterCartHandler(s server.Server, hdlr CartHandler, opts ...server.HandlerOption) error {
	type cart interface {
		...
		DeleteItemByID(ctx context.Context, in *CarID, out *Response) error
...
func (h *cartHandler) DeleteItemByID(ctx context.Context, in *CarID, out *Response) error {
